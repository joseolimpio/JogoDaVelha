...
//variaveis
private JFrame window = new JFrame("Jogo-da-Velha");
...
//Mostra no botão a marca de quem for o dono do turno
...
//Diálogo quando o vencer.
if(win == true){
JOptionPane.showMessageDialog(null, letter + " Venceu!");
